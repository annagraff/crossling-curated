...
autotyp_languages <- read.csv("../../raw/autotyp_v.1.1.1/languages.csv",header=TRUE, sep=",")
autotyp_parameters <- read.csv("../../raw/autotyp_v.1.1.1/parameters.csv",header=TRUE, sep=",")
...
autotyp_values <- read.csv("../../raw/autotyp_v.1.1.1/values.csv",header=TRUE, sep=",")
...
lexibank_lgs <- read.csv("../../raw/lexibank_v.1.0/languages.csv",header=TRUE, sep=",")
lexibank_lexicon <- read.csv("../../raw/lexibank_v.1.0/lexicon-values.csv",header=TRUE, sep=",")
lexibank_phonology <- read.csv("../../raw/lexibank_v.1.0/phonology-values.csv",header=TRUE, sep=",")
...
phoible_data <- local({
  ...
  phoible <- read_csv("../../raw/phoible_v.20230416.csv", # url("https://raw.githubusercontent.com/phoible/dev/master/data/phoible.csv") after the last commit as of January 2024 (https://github.com/phoible/dev/commit/7030ae02863f0e1ddaf67f0f950c0ea1477cd4ee)
...
write.csv(typology_merged,"output/compiled_external_input_features.csv",row.names = F)
