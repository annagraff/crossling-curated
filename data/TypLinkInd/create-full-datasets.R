...
original_variable_matrix <- as.data.frame(read_csv("output/compiled_external_input_features.csv", 
...
original_variable_matrix <- update_glottocode_and_data(data=original_variable_matrix, old="jogl1236", new="tase1235") # Jugli from WALS
...
write.csv(logical_long,"output/logicalTLI/cldf/values.csv",fileEncoding="UTF-8",row.names = F)
write.csv(statistical_long,"output/statisticalTLI/cldf/values.csv",fileEncoding="UTF-8",row.names = F)
