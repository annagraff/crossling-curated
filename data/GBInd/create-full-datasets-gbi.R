...
original_variable_matrix <- as.data.frame(read_csv("../../raw/grambank_v.1.0.3.csv", 
...
# this full set of all input and recoded variables needs to be stored to perform statistical tests
...
### logical dataset: check all original variables that should be in the logical filter are in there and vice versa
...
# logical dataset is: a) original variables, plus b) all design/logical additions, minus c) all design/logical removals
...
### statistical dataset: check all original variables that should be in the statistical filter are in there and vice versa
...
# statistical dataset is: a) the variables from the final logical dataset, plus b) all statistical additions, minus c) all statistical removals
