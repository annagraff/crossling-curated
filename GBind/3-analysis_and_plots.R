...
logical_full <- read.csv("output/logicalGBI/logicalGBI.csv",row.names = "glottocode") %>% select(-X)
...
logical_densified <- read.csv("output/logicalGBI/logicalGBI_pruned.csv", row.names = "X")
logical_densified <- na_convert(logical_densified)
logical_densified <- factorise(logical_densified)

statistical_full <- read.csv("output/statisticalGBI/statisticalGBI.csv",row.names = "glottocode") %>% select(-X)
...
statistical_densified <- read.csv("output/statisticalGBI/statisticalGBI_pruned.csv", row.names = "X")
...
report_loadings(per_family_props_PCA_logical_full, directory = "logicalGBI", pc = 1, nr_variables_from_top_and_bottom = 5)
report_loadings(per_family_props_PCA_logical_full, directory = "logicalGBI", pc = 2, nr_variables_from_top_and_bottom = 5)
report_loadings(per_family_props_PCA_logical_full, directory = "logicalGBI", pc = 3, nr_variables_from_top_and_bottom = 5)

report_loadings(per_family_props_PCA_logical_densified, directory = "logicalGBI", pc = 1, nr_variables_from_top_and_bottom = 5)
report_loadings(per_family_props_PCA_logical_densified, directory = "logicalGBI", pc = 2, nr_variables_from_top_and_bottom = 5)
report_loadings(per_family_props_PCA_logical_densified, directory = "logicalGBI", pc = 3, nr_variables_from_top_and_bottom = 5)

report_loadings(per_family_props_PCA_statistical_full, directory = "statisticalGBI", pc = 1, nr_variables_from_top_and_bottom = 5)
report_loadings(per_family_props_PCA_statistical_full, directory = "statisticalGBI", pc = 2, nr_variables_from_top_and_bottom = 5)
report_loadings(per_family_props_PCA_statistical_full, directory = "statisticalGBI", pc = 3, nr_variables_from_top_and_bottom = 5)

report_loadings(per_family_props_PCA_statistical_densified, directory = "statisticalGBI", pc = 1, nr_variables_from_top_and_bottom = 5)
report_loadings(per_family_props_PCA_statistical_densified, directory = "statisticalGBI", pc = 2, nr_variables_from_top_and_bottom = 5)
report_loadings(per_family_props_PCA_statistical_densified, directory = "statisticalGBI", pc = 3, nr_variables_from_top_and_bottom = 5)
