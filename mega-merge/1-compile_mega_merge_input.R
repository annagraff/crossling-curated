...
phoible_data <- local({
  ...
  phoible <- read_csv("../input/phoible_v.20230728.csv", # url("https://raw.githubusercontent.com/phoible/dev/master/data/phoible.csv" from 28 July 2023
  ...
  # now compute counts and presence per glottocode
