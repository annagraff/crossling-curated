...
modifications <- read.csv("output/statisticalMM/cldf/modifications.csv")
diversity_samples <- read.csv("output/1000_diversity_samples_seed_2023.csv", row.names = 1)
recoded_data <- read.csv("output/logicalMM/full/logicalMM_full.csv", row.names = "X")
...
ggsave("../figures-for-paper/main/methods_plots.png", plot = combined_plot_full, width = 14, height = 8, dpi = 300)
