...
#### GBI logical and statistical datasets. Before saving, logical quality checks are performed on the outputs.
...
recode_patterns <- read.csv("scripts/GBI/feature-recode-patterns.csv")
all_decisions <- read.csv("scripts/GBI/decisions-log.csv")
...
# parameters.csv
parameters <- read.csv("scripts/GBI/feature-recode-patterns.csv")
...
# modifications.csv
modifications <- read.csv("scripts/GBI/decisions-log.csv")
