...
#### TLI logical and statistical datasets. Before saving, logical quality checks are performed on the outputs.
...
original_feature_matrix <- as.data.frame(read_csv("curated_data/TLI/compiled_external_input_features.csv", 
...
recode_patterns <- read.csv("scripts/TLI/feature-recode-patterns.csv")
...
write.csv(recoded_data, "curated_data/TLI/statisticalTLI/data_for_stats.csv")

# subset full data into original layer; logical layer and statistical layer
recode_patterns <- read.csv("scripts/TLI/feature-recode-patterns.csv")
all_decisions <- read.csv("scripts/TLI/decisions-log.csv")
...
input_nas <- as.data.frame(read_csv("curated_data/TLI/compiled_external_input_features.csv", 
                                    trim_ws = FALSE, col_types = "f"))
...
write.csv(logical_data,"curated_data/TLI/logicalTLI/full/logicalTLI_full.csv")
write.csv(statistical_data,"curated_data/TLI/statisticalTLI/full/statisticalTLI_full.csv")
...
# parameters.csv
parameters <- read.csv("scripts/TLI/feature-recode-patterns.csv") %>% select(1:24)
...
# modifications.csv
modifications <- read.csv("scripts/TLI/decisions-log.csv")
...
write.csv(taxonomy_logical,"curated_data/TLI/logicalTLI/cldf/languages.csv",fileEncoding="UTF-8",row.names = F)
write.csv(taxonomy_statistical,"curated_data/TLI/statisticalTLI/cldf/languages.csv",fileEncoding="UTF-8",row.names = F)
write.csv(parameters_logical,"curated_data/TLI/logicalTLI/cldf/parameters.csv",fileEncoding="UTF-8",row.names = F)
write.csv(parameters_statistical,"curated_data/TLI/statisticalTLI/cldf/parameters.csv",fileEncoding="UTF-8",row.names = F)
write.csv(logical_long,file="curated_data/TLI/logicalTLI/cldf/values.csv",row.names = F)
write.csv(statistical_long,file="curated_data/TLI/statisticalTLI/cldf/values.csv",row.names = F)
write.csv(logical_codes,"curated_data/TLI/logicalTLI/cldf/codes.csv",fileEncoding="UTF-8",row.names = F)
write.csv(statistical_codes,"curated_data/TLI/statisticalTLI/cldf/codes.csv",fileEncoding="UTF-8",row.names = F)
write.csv(modifications,"curated_data/TLI/logicalTLI/cldf/modifications.csv",fileEncoding="UTF-8",row.names = F)
write.csv(modifications,"curated_data/TLI/statisticalTLI/cldf/modifications.csv",fileEncoding="UTF-8",row.names = F)
